          ...
          function et(t) {
            ...
            if (h) {
              var A = X(i),
                ...
                P = 'clientWidth'
              if (
                (A === T(i) && 'static' !== R((A = N(i))).position && 'absolute' === p && ((j = 'scrollHeight'), (P = 'scrollWidth')), c === n || ((c === s || c === r) && l === d))
              )
              ...
              : ht(
                  (function (t) {
                    var e,
                      ...
                      c = -n.scrollTop
                    return (
                      'rtl' === R(o || i).direction && (a += D(i.clientWidth, o ? o.clientWidth : 0) - r),
                      {
                        width: r,
                        height: s,
                        x: a,
                        ...
                        I(i) === a
                          ? (function (t, e) {
                              ...
                              var h = f.reduce(function (e, i) {
                                return (e[i] = yt(t, { placement: i, boundary: o, rootBoundary: r, padding: s })[I(i)]), e
                              }, {})
